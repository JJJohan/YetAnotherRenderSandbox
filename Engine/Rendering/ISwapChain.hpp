...
namespace Engine::Rendering
{
	...
	public:
		...
		inline const IImageView& GetSwapChainImageView(uint32_t imageIndex) const { return *m_swapChainImageViews[imageIndex]; }
	...
	protected:
		...
		std::vector<std::unique_ptr<IImageView>> m_swapChainImageViews;
